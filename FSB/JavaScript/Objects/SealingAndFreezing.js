...
// A while back we saw the use of the Object.defineProperty() method for modifying properties or configuring existing properties to set their data descriptors.   
...
// The Object.seal() method prevents new properties from being added to an object and it also sets all properties as non-configurable which means you cannot delete any properties. That said, you can still mutate their value. This is great when you do not want the shape of the object to be changed.


// Object.freeze()

// The Object.freeze() method completely freezes the object which means that you can neither mutate values nor add or remove properties or any other thing. 
// Frozen objects including arrays are extremely useful in situations where you do not want accidental data or shape mutation in any way.
