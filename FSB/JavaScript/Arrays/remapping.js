...
// Array.map() is one of the most useful of all Array methods, especially when building web applications using libraries/frameworks like React where data mutation is frowned upon and is counter productive.

// see an array of objects representing citizens with their age and name. We want to add a new property to every object in this array called isSeniorCitizen which should be true if the age of the citizen is greater than or equal to 60. And we want to create a new array in the process.
...
// Array.map() takes a callback function as an argument which is run for every element in the array to create anew resultant array.
