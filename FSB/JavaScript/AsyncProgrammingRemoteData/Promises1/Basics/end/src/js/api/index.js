...
// Asynchronous function is a function that will not block the execution of your code and will
// resolve with its result whenever ready.

// A promise is an intent to do something (such as provide data) at a future time and it does not
// gurantee success or failure but is an expression to provide with an outcome, whether successful or
// unsuccessful.
